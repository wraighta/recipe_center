<?php
    ...
    $con = mysqli_connect("localhost", "test", "test","recipe") or die('Sorry, could not connect to database');
    ...
    } else
    {
        while($row=mysqli_fetch_array($result, MYSQL_ASSOC))
        {
            ...
            echo "<a href=\"../recipe/index.php?content=showrecipe&id=$recipeid\">$title</a><br>\n";
